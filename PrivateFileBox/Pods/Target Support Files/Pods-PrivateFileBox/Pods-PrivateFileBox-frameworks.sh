...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TYProgressBar/TYProgressBar.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VIMediaCache/VIMediaCache.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ZWAlertController/ZWAlertController.framework"
